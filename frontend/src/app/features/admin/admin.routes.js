export const ADMIN_ROUTES = [
    ...
    },
    {
        ...
        loadComponent: () => import('./pages/admin-courses-pending/admin-courses-pending.component').then((m) => m.AdminCoursesPendingComponent)
    },
    {
        path: 'audit-logs',
    ...
    {
        path: 'gdpr',
        loadComponent: () => import('./pages/admin-gdpr/admin-gdpr.component').then((m) => m.AdminGdprComponent)
    },
    {
        path: 'badges',
        loadComponent: () => import('./pages/admin-badges/admin-badges.component').then((m) => m.AdminBadgesComponent)
    },
    {
        path: 'certificates',
